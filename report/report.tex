...
The transverse magnetization vector follows a slightly different evolution. Before introducing the T2 parameter associated with its evolution, we establish a notation to indicate this magnetization vector: since it lies on the x-y plane it has two component so we can write $M_\perp = M_x \hat x + M_y \hat y$.

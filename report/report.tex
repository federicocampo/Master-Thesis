...
% Talk about abide preprocessed 4 different pipelines and compare some rois between my data and abide preproc data.
...
%insert an image of k-fold example
...
From the initial input data consisting of 5995 features, we tried different to classify using 20, 50, 100 and 200 principal components

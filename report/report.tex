...
\end{subfigure}
\caption{Two different but equivalent plots of shap values for the first 20 most important features obtained from data where harmonization procedure is implemented inside the k-fold CV scheme
}
